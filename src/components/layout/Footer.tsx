    ...
    <footer className="footer-root">
      <div className="container footer-container">
        ...
        <div className="footer-col brand-col">
          ...
          <div className="footer-socials">
            ...
            <a href={socials.youtube} target="_blank" rel="noopener noreferrer" className="social-icon-link" aria-label="YouTube">
              <svg className="social-icon" width="28" height="28" viewBox="0 0 24 24">
            ...
            <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" className="social-icon-link" aria-label="LinkedIn">
              <svg className="social-icon" width="28" height="28" viewBox="0 0 24 24">
            ...
            <a href={socials.twitter} target="_blank" rel="noopener noreferrer" className="social-icon-link" aria-label="X">
              <svg className="social-icon" width="28" height="28" viewBox="0 0 24 24">
        ...
        <div className="footer-col office-col">
          ...
          <div className="office-item">
            ...
            <div className="office-hours">
              ...
              <span className="office-hours-time">{officeData.hours}</span>
            </div>
          </div>
        </div>
        ...
        <div className="footer-col phone-col">
          <div className="phone-row">
            ...
            <div className="phone-text">
              <a href={`tel:${officeData.tollFree.replace(/\s+/g, '')}`} className="phone-number">{officeData.tollFree}</a>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-container">
          <p className="copyright-text">{officeData.copyright}</p>
